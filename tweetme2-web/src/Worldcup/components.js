...
export function WorldcupFeedComponent(props) {
...
export function WorldcupCommentFeedComponent(props) {
...
export function WorldcupTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function WorldcupTweetDetailComponent(props){
  const {tweetId} = props
...
export function WorldcupCommentDetailComponent(props){
