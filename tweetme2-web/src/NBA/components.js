...
export function NBAFeedComponent(props) {
...
export function NBACommentFeedComponent(props) {
...
export function NBATweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function NBATweetDetailComponent(props){
  const {tweetId} = props
...
export function NBACommentDetailComponent(props){
