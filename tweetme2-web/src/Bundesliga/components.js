...
export function BundesligaFeedComponent(props) {
...
export function BundesligaCommentFeedComponent(props) {
...
export function BundesligaTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function BundesligaTweetDetailComponent(props){
  const {tweetId} = props
...
export function BundesligaCommentDetailComponent(props){
