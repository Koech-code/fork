...
export function BaseballFeedComponent(props) {
...
export function BaseballCommentFeedComponent(props) {
...
export function BaseballTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function BaseballTweetDetailComponent(props){
  const {tweetId} = props
...
export function BaseballCommentDetailComponent(props){
