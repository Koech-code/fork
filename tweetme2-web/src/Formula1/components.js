...
export function Formula1FeedComponent(props) {
...
export function Formula1CommentFeedComponent(props) {
...
export function Formula1TweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function Formula1TweetDetailComponent(props){
  const {tweetId} = props
...
export function Formula1CommentDetailComponent(props){
