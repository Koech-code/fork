...
export function AfconFeedComponent(props) {
...
export function AfconCommentFeedComponent(props) {
...
export function AfconTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function AfconTweetDetailComponent(props){
  const {tweetId} = props
...
export function AfconCommentDetailComponent(props){
