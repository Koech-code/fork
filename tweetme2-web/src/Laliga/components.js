...
export function LaligaFeedComponent(props) {
...
export function LaligaCommentFeedComponent(props) {
...
export function LaligaTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function LaligaTweetDetailComponent(props){
  const {tweetId} = props
...
export function LaligaCommentDetailComponent(props){
