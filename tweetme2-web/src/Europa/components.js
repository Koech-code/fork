...
export function EuropaFeedComponent(props) {
...
export function EuropaCommentFeedComponent(props) {
...
export function EuropaTweetsComponent(props) {
    const [newTweets, setNewTweets] = useState([])
    const canTweet = props.canTweet === "false" ? false : true
    const handleNewTweet = (newTweet) =>{
      let tempNewTweets = [...newTweets]
...
export function EuropaTweetDetailComponent(props){
  const {tweetId} = props
...
export function EuropaCommentDetailComponent(props){
